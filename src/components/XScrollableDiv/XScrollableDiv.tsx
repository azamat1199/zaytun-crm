...
const XScrollableDiv: FC<XScrollableDivProps> = ({
    ...
    function animateScroll() {
        ...
        const animation = setInterval(
            ...
            Math.floor(
                direction.current === "right"
                    ? (targetScrollLeft - container.scrollLeft) / 10
                    : (container.scrollLeft - targetScrollLeft) / 10,
            ),
    ...
    return (
        <div
            ...
            onMouseDown={(event) => {
                ...
                startX.current =
                    event.pageX - (containerRef.current?.offsetLeft || 0);
