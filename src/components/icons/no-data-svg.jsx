        ...
        >
            <g clipPath="url(#EmptyDocuments_svg__a)" opacity="0.84">
                ...
                <path
                    ...
                    strokeWidth="2.5"
                    d="M135.811 7.082v12.564a3.25 3.25 0 003.25 3.25h8.595m-53.012 55.25h28.167m-28.167-55.25h28.167-28.167zm0 13h46.584-46.584zm0 14.083h46.584-46.584zm0 14.084h46.584-46.584z"
                ></path>
            </g>
            <defs>
