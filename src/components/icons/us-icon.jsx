...
function UsIcon() {
    return (
        <svg
            ...
            viewBox="0 0 24 24"
        >
            <g clipPath="url(#clip0_3854_76584)">
                <path
                    fill="#F0F0F0"
                ...
                <path
                    fill="#D80027"
                    d="M11.478 12H24c0-1.084-.145-2.133-.414-3.13H11.478V12zM11.478 5.738h10.76a12.064 12.064 0 00-2.769-3.13h-7.991v3.13zM12 24c2.824 0 5.42-.977 7.47-2.61H4.53A11.948 11.948 0 0012 24zM1.761 18.26h20.477a11.93 11.93 0 001.348-3.131H.413c.3 1.116.758 2.168 1.348 3.13z"
                ></path>
                <path
                    fill="#0052B4"
